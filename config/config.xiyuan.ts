function makeAppConfig() {
  ...
  const AppConfig = {
    ...
    productLink: "https://www.futurestack.cn",
    // Global Config
    ...
    // serverURL: "https://daj.nc.gov.cn/parse",
    masterKey: "NovaTest666",
    homeURL: "https://cloud.futurestack.cn",
    ...
    permission: {
      admin: [
        ...
        // 用户认证
        "org",
        "admin.org.enterprise",
        "admin.org.enterprise.category",
        "admin.certify.all",
        "admin.certify.org.vip",
        "admin.user.org",
        // 消息管理
        "common-message",
      ],
