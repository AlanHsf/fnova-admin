...
@Component({
  selector: "app-print-surveylog",
  templateUrl: "./print-surveylog.component.html",
  styleUrls: ["./print-surveylog.component.scss"],
})
export class PrintSurveylogComponent implements OnInit {
  constructor(
  ...
  */
  async exportPDF() {
    let documentTitle = `${this.exam.get("title")}-${this.profile.get("name")}`;
