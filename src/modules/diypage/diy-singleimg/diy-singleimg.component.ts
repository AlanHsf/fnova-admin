...
@Component({
  selector: 'app-diy-singleimg',
  templateUrl: './diy-singleimg.component.html',
  styleUrls: ['./diy-singleimg.component.scss']
})
export class DiySingleimgComponent implements OnInit {
