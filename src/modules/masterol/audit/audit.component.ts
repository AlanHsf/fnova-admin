...
export class AuditComponent implements OnInit {
  ...
  async getData() {
    ...
    let sql = `select
                ...
                (select pr."yetTuitionFee" from "ProfileRecharge" as pr where pr."profile"=p."objectId") as "yetTuitionFee",
                (select pr."serviceFee" from "ProfileRecharge" as pr where pr."profile"=p."objectId") as servicefee,
                (select pr."yetServiceFee" from "ProfileRecharge" as pr where pr."profile"=p."objectId") as "yetServiceFee",
                (select pr."paperFee" from "ProfileRecharge" as pr where pr."profile"=p."objectId") as paperfee,
                (select pr."yetPaperFee" from "ProfileRecharge" as pr where pr."profile"=p."objectId") as "yetPaperFee",
