...
// public jimService: JIMService,
// this.jimService.sendMessage('BFI7InsgLx', '1234567,我是机器人')
// await this.jimService.jimOnSyncConversation()
// await this.jimService.startMsgReceive();
@Component({
