...
export class AxieDashboardOverviewComponent implements OnInit {
  ...
  async getMainnetPrice(){
    let response = await (await fetch("https://api.coingecko.com/api/v3/simple/price?ids=axie-infinity%2Cethereum%2Csmooth-love-potion&vs_currencies=eth%2Cusd%2Cphp%2Cgbp%2Ceur%2Csek", {
        // "credentials": "omit",
        // "headers": {
        ...
        // },
        // "referrer": "https://www.chillaxie.com/breeding-costs",
        "method": "GET",
        // "mode": "cors"
    })).json();

    let result = {
      slp: response&&response["smooth-love-potion"]&&response["smooth-love-potion"]["usd"] || 0,
      eth: response&&response["ethereum"]&&response["ethereum"]["usd"] || 0,
      axs: response&&response["axie-infinity"]&&response["axie-infinity"]["usd"] || 0
    }
    this.mainnetPrice = result
    return result;
  }
  async getMarketStats(){
    let response = await  (await fetch("https://graphql-gateway.axieinfinity.com/graphql", {
    "credentials": "include",
    "headers": {
        "content-type": "application/json",
    },
    "referrer": "https://marketplace.axieinfinity.com/?__cf_chl_captcha_tk__=pmd_Y3Dp4nKK5eQL0K08hLpjS5WGXUDQ7G7et4hkobjjWtE-1632736059-0-gqNtZGzNAuWjcnBszQn9",
    "body": "{\"operationName\":\"GetOverviewToday\",\"variables\":{},\"query\":\"query GetOverviewToday {\\n  marketStats {\\n    last24Hours {\\n      ...OverviewFragment\\n      __typename\\n    }\\n    last7Days {\\n      ...OverviewFragment\\n      __typename\\n    }\\n    last30Days {\\n      ...OverviewFragment\\n      __typename\\n    }\\n    __typename\\n  }\\n}\\n\\nfragment OverviewFragment on SettlementStats {\\n  count\\n  axieCount\\n  volume\\n  volumeUsd\\n  __typename\\n}\\n\"}",
    "method": "POST",
    "mode": "cors"
})).json();
    let result = response&&response.data.marketStats
    result.volume = Number(result.last24Hours.volume)
    result.volumeUsd = Number(result.last24Hours.volumeUsd)

    this.marketStats = result
    return response&&response.data.marketStats
  }
  // 最新挂单
  ...
  this.recentlyList = response&&response.data.axies
  console.log(this.recentlyList)
      return response&&response.data.axies
  ...
  async getRecentlySold(){
    let response = await (await fetch("https://graphql-gateway.axieinfinity.com/graphql", {
      ...
      "referrer": "https://marketplace.axieinfinity.com/?__cf_chl_captcha_tk__=pmd_Y3Dp4nKK5eQL0K08hLpjS5WGXUDQ7G7et4hkobjjWtE-1632736059-0-gqNtZGzNAuWjcnBszQn9",
      "body": "{\"operationName\":\"GetRecentlyAxiesSold\",\"variables\":{\"from\":0,\"size\":10,\"sort\":\"Latest\",\"auctionType\":\"Sale\"},\"query\":\"query GetRecentlyAxiesSold($from: Int, $size: Int) {\\n  settledAuctions {\\n    axies(from: $from, size: $size) {\\n      total\\n      results {\\n        ...AxieSettledBrief\\n        transferHistory {\\n          ...TransferHistoryInSettledAuction\\n          __typename\\n        }\\n        __typename\\n      }\\n      __typename\\n    }\\n    __typename\\n  }\\n}\\n\\nfragment AxieSettledBrief on Axie {\\n  id\\n  name\\n  image\\n  class\\n  breedCount\\n  __typename\\n}\\n\\nfragment TransferHistoryInSettledAuction on TransferRecords {\\n  total\\n  results {\\n    ...TransferRecordInSettledAuction\\n    __typename\\n  }\\n  __typename\\n}\\n\\nfragment TransferRecordInSettledAuction on TransferRecord {\\n  from\\n  to\\n  txHash\\n  timestamp\\n  withPrice\\n  withPriceUsd\\n  fromProfile {\\n    name\\n    __typename\\n  }\\n  toProfile {\\n    name\\n    __typename\\n  }\\n  __typename\\n}\\n\"}",
      "method": "POST",
      "mode": "cors"
  })).json();
  this.recentlySold = response&&response.data.axies
  console.log(this.recentlySold)
