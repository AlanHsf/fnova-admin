...
import GameService from "./game.serv"
var gameServ = new GameService(electron,appConfig);

import DownloadService from "./download.serv"
var downloadServ = new DownloadService(electron,appConfig);
...
function newSplashView(){
  ...
  splashView.setBounds({width:width,height:1200,x:0,y:0})
...
function newAdminView(){
  ...
  adminView.setBounds({width:width,height:1080,x:0,y:0})
