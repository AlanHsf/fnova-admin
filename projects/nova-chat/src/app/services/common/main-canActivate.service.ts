...
export class MainCanActivate implements CanActivate {
    ...
    public canActivate(): boolean | Promise<boolean> {
        ...
        let storageUsername = this.storageService.get(md5('afterFiveMinutes-username'), true);
        let storagePassword = this.storageService.get(md5('afterFiveMinutes-password'), true);
